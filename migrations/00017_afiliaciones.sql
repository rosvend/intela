...
-- luego 00015, luego 00016. Esos numeros ya no se pueden usar: `main` aplico
-- hasta 00016 (`00016_liquidacion.sql`, #80) y dos ficheros en la misma
-- version hacen que goose entre en panic (duplicate version 16). goose corre
